    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '1.25rem', fontWeight: 900, color: 'var(--status-success)' }}>99.2%</div>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '1.25rem', fontWeight: 900, color: '#06b6d4' }}>Stripe 3DS Secured</div>
          </div>
        </div>
      </div>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '24px 28px' }}>
        ...
        >
          ...
          <div
            style={{
              display: 'grid',
              gridTemplateColumns: '1.2fr 1.6fr 1.2fr 1fr 1.2fr 1fr 0.8fr',
              padding: '14px 20px',
              background: 'var(--surface-glass)',
              borderBottom: '1px solid var(--border-subtle)',
              fontSize: '0.76rem',
          ...
          {paginatedTransactions.length === 0 ? (
            ...
            paginatedTransactions.map((tx) => (
              ...
              >
                ...
                {/* Tier */}
                <div>
                  <span className="kinetic-badge" style={{ fontSize: '0.7rem', padding: '2px 8px' }}>
                    {tx.tier}
                  </span>
                </div>
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <span style={{ fontSize: '0.82rem', color: 'var(--text-primary)', fontWeight: 800, padding: '0 6px' }}>
